...
class SwipeTutorial extends StatelessWidget {
  const SwipeTutorial({super.key, required this.child, required this.direction, required this.scaffolfKey})
      : assert(direction == null || direction == AxisDirection.left || direction == AxisDirection.right,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                alignment:
                                    direction == AxisDirection.left ? Alignment.centerRight : Alignment.centerLeft,
  ...
  void _handleSwipeAction(BuildContext context, double dx) {
    if (direction == AxisDirection.left && dx < -20) {
      GetIt.I<AppState>().incrementSwipeTutorialStep(2);
